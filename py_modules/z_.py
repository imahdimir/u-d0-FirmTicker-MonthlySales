...
def find_rev_until_last_month_modified_prod(self) :
    ...
    if len(until_last_m_modified) == 1 :
        ...
        self.output[rd.revUntilLastMonthModified] = cf.read_accvalue_from_str(
                str(self.fixed_table.at[self.sum_row , until_last_m_modified]))
...
def find_until_current_month(self) :
    ...
    if len(until_cur_m) == 1 :
        ...
        self.output[rd.revUntilCurrnetMonth] = cf.read_accvalue_from_str(str(
